///* -*- C++ -*-
// * 
// *  NativeScript_command.cpp - Command executer of NativeScript
// *
...
//
//
//int NativeScript::yesnoboxCommand()
//{
...
//}
//
//int NativeScript::wavestopCommand()
//{
...
//}
//
//int NativeScript::waittimerCommand()
//{
...
//}
//
//int NativeScript::voicevolCommand()
//{
...
//}
//
//int NativeScript::transbtnCommand()
//{
//    transbtn_flag = true;
//
//    return RET_CONTINUE;
//}
//
//int NativeScript::textspeeddefaultCommand()
//{
//    sentence_font.wait_time = -1;
//    return RET_CONTINUE;
//}
//
//int NativeScript::textspeedCommand()
//{
...
//}
//
//int NativeScript::textshowCommand()
//{
...
//}
//
//int NativeScript::textonCommand()
//{
...
//}
//
//int NativeScript::textoffCommand()
//{
//    if (windowchip_sprite_no >= 0)
...
//}
//
//int NativeScript::texthideCommand()
//{
//    dirty_rect.fill( screen_width, screen_height );
...
//}
//
//int NativeScript::textclearCommand()
//{
//    newPage();
//    return RET_CONTINUE;
//}
//
//int NativeScript::texecCommand()
//{
...
//}
//
//int NativeScript::tateyokoCommand()
//{
...
//}
//
//int NativeScript::tablegotoCommand()
//{
//    int count = 0;
//    int no = script_h.readInt();
//
...
//}
//
//int NativeScript::systemcallCommand()
//{
...
//}
//
//int NativeScript::sp_rgb_gradationCommand()
//{
//    int no = script_h.readInt();
...
//}
//
//int NativeScript::spreloadCommand()
//{
//    int no = script_h.readInt();
//    AnimationInfo *ai;
//    if (no == -1) ai = &sentence_font_info;
...
//}
//
//int NativeScript::spclclkCommand()
//{
...
//}
//
//int NativeScript::skipoffCommand() 
//{ 
...
//}
//
//void NativeScript::setwindowCore()
//{
...
//}
//
//int NativeScript::setwindow3Command()
//{
//    setwindowCore();
//    
//    clearCurrentPage();
...
//}
//
//int NativeScript::setwindow2Command()
//{
//    const char *buf = script_h.readStr();
//    if ( buf[0] == '#' ){
//        sentence_font.is_transparent = true;
...
//}
//
//int NativeScript::setwindowCommand()
//{
//    setwindowCore();
//    
...
//}
//
//int NativeScript::setcursorCommand()
//{
//    bool abs_flag;
//
...
//}
//
//int NativeScript::selectCommand()
//{
//    enterTextDisplayMode();
//
...
//}
//
//int NativeScript::savetimeCommand()
//{
//    int no = script_h.readInt();
//
//    SaveFileInfo info;
...
//}
//
//int NativeScript::savescreenshotCommand()
//{
...
//}
//
//int NativeScript::saveonCommand()
//{
//    saveon_flag = true;
//
//    return RET_CONTINUE;
//}
//
//int NativeScript::saveoffCommand()
//{
...
//}
//
//int NativeScript::savegameCommand()
//{
...
//}
//
//int NativeScript::savefileexistCommand()
//{
//    script_h.readInt();
//    script_h.pushVariable();
//    int no = script_h.readInt();
...
//}
//
//int NativeScript::resettimerCommand()
//{
...
//}
//
//int NativeScript::repaintCommand()
//{
//    dirty_rect.fill( screen_width, screen_height );
//    flush( refreshMode() );
//    
...
//}
//
//int NativeScript::puttextCommand()
//{
...
//}
//
//int NativeScript::prnumclearCommand()
//{
...
//}
//
//int NativeScript::playstopCommand()
//{
//    stopBGM( false );
//
//    return RET_CONTINUE;
...
//}
//
//int NativeScript::ofscopyCommand()
//{
...
//}
//
//int NativeScript::mpegplayCommand()
//{
//    script_h.readStr();
//    const char *save_buf = script_h.saveStringBuffer();
//    
...
//}
//
//int NativeScript::mp3volCommand()
//{
...
//}
//
//int NativeScript::mp3stopCommand()
//{
...
//}
//
//int NativeScript::mp3fadeoutCommand()
//{
...
//}
//
//int NativeScript::mp3fadeinCommand()
//{
...
//}
//
//int NativeScript::movemousecursorCommand()
//{
...
//}
//
//int NativeScript::monocroCommand()
//{
//    if ( script_h.compareString( "off" ) ){
//        script_h.readLabel();
//        monocro_flag = false;
...
//}
//
//int NativeScript::menu_windowCommand()
//{
//    if ( fullscreen_mode ){
//#if !defined(PSP)
...
//}
//
//int NativeScript::menu_fullCommand()
//{
//    if ( !fullscreen_mode ){
//#if !defined(PSP)
//        if ( !SDL_WM_ToggleFullScreen( screen_surface ) ){
...
//}
//
//int NativeScript::menu_automodeCommand()
//{
//    automode_flag = true;
//    skip_mode &= ~SKIP_NORMAL;
...
//}
//
//int NativeScript::loopbgmstopCommand()
//{
...
//}
//
//int NativeScript::loopbgmCommand()
//{
//    const char *buf = script_h.readStr();
...
//}
//
//int NativeScript::lookbackflushCommand()
//{
...
//}
//
//int NativeScript::lookbackbuttonCommand()
//{
//    for ( int i=0 ; i<4 ; i++ ){
//        const char *buf = script_h.readStr();
...
//}
//
//int NativeScript::locateCommand()
//{
//    int x = script_h.readInt();
//    int y = script_h.readInt();
...
//}
//
//int NativeScript::loadgameCommand()
//{
//    int no = script_h.readInt();
//
//    if ( no < 0 )
...
//}
//
//int NativeScript::kinsokuCommand()
//{
...
//}
//
//int NativeScript::ispageCommand()
//{
//    script_h.readInt();
//
//    if ( textgosub_clickstr_state == CLICK_NEWPAGE )
...
//}
//
//int NativeScript::isfullCommand()
//{
//    script_h.readInt();
...
//}
//
//int NativeScript::isskipCommand()
//{
//    script_h.readInt();
//
//    if ( automode_flag )
...
//}
//
//int NativeScript::isdownCommand()
//{
//    script_h.readInt();
//
...
//}
//
//int NativeScript::indentCommand()
//{
...
//}
//
//int NativeScript::humanorderCommand()
//{
//    leaveTextDisplayMode();
//    
//    const char *buf = script_h.readStr();
...
//}
//
//int NativeScript::getzxcCommand()
//{
//    getzxc_flag = true;
//
//    return RET_CONTINUE;
//}
//
//int NativeScript::getvoicevolCommand()
//{
//    script_h.readInt();
...
//}
//
//int NativeScript::getversionCommand()
//{
//    script_h.readInt();
...
//}
//
//int NativeScript::gettimerCommand()
//{
...
//}
//
//int NativeScript::gettextCommand()
//{
//    script_h.readStr();
//    int no = script_h.current_variable.var_no;
//
...
//}
//
//int NativeScript::gettaglogCommand()
//{
//    script_h.readVariable();
//    script_h.pushVariable();
//
...
//}
//
//int NativeScript::gettagCommand()
//{
...
//}
//
//int NativeScript::gettabCommand()
//{
//    gettab_flag = true;
//    
//    return RET_CONTINUE;
//}
//
//int NativeScript::getspsizeCommand()
//{
//    int no = script_h.readInt();
//
//    script_h.readVariable();
...
//}
//
//int NativeScript::getspposCommand()
//{
//    int no = script_h.readInt();
//    
//    script_h.readVariable();
...
//}
//
//int NativeScript::getspmodeCommand()
//{
//    script_h.readVariable();
//    script_h.pushVariable();
//
...
//}
//
//int NativeScript::getsevolCommand()
//{
//    script_h.readInt();
...
//}
//
//int NativeScript::getscreenshotCommand()
//{
...
//}
//
//int NativeScript::getsavestrCommand()
//{
//    script_h.readVariable();
//    if ( script_h.current_variable.type != ScriptHandler::VAR_STR )
...
//}
//
//int NativeScript::getpageupCommand()
//{
//    getpageup_flag = true;
//    
//    return RET_CONTINUE;
//}
//
//int NativeScript::getpageCommand()
//{
//    getpageup_flag = true;
...
//}
//
//int NativeScript::getretCommand()
//{
//    script_h.readVariable();
//
//    if ( script_h.current_variable.type == ScriptHandler::VAR_INT ||
...
//}
//
//int NativeScript::getregCommand()
//{
//    script_h.readVariable();
//    
//    if ( script_h.current_variable.type != ScriptHandler::VAR_STR ) 
...
//}
//
//int NativeScript::getmp3volCommand()
//{
//    script_h.readInt();
...
//}
//
//int NativeScript::getmouseposCommand()
//{
//    script_h.readInt();
...
//}
//
//int NativeScript::getmouseoverCommand()
//{
...
//}
//
//int NativeScript::getlogCommand()
//{
//    script_h.readVariable();
//    script_h.pushVariable();
//
...
//}
//
//int NativeScript::getinsertCommand()
//{
//    getinsert_flag = true;
//
//    return RET_CONTINUE;
//}
//
//int NativeScript::getfunctionCommand()
//{
...
//}
//
//int NativeScript::getenterCommand()
//{
//    if ( !force_button_shortcut_flag )
//        getenter_flag = true;
//    
...
//}
//
//int NativeScript::getcursorpos2Command()
//{
//    script_h.readInt();
...
//}
//
//int NativeScript::getcursorposCommand()
//{
...
//}
//
//int NativeScript::getcursorCommand()
//{
//    if ( !force_button_shortcut_flag )
//        getcursor_flag = true;
//    
...
//}
//
//int NativeScript::getcselstrCommand()
//{
//    script_h.readVariable();
//    script_h.pushVariable();
//
...
//}
//
//int NativeScript::getcselnumCommand()
//{
//    int count = 0;
//
//    SelectLink *link = root_select_link.next;
...
//}
//
//int NativeScript::fileexistCommand()
//{
//    script_h.readInt();
//    script_h.pushVariable();
//    const char *buf = script_h.readStr();
...
//}
//
//int NativeScript::exec_dllCommand()
//{
//    const char *buf = script_h.readStr();
//    char dll_name[256];
//    unsigned int c=0;
...
//}
//
//int NativeScript::erasetextwindowCommand()
//{
...
//}
//
//int NativeScript::dwavestopCommand()
//{
...
//}
//
//int NativeScript::drawtextCommand()
//{
...
//}
//
//int NativeScript::drawsp3Command()
//{
//    int sprite_no = script_h.readInt();
...
//}
//
//int NativeScript::drawsp2Command()
//{
//    int sprite_no = script_h.readInt();
//    int cell_no = script_h.readInt();
//    int alpha = script_h.readInt();
...
//}
//
//int NativeScript::drawspCommand()
//{
//    int sprite_no = script_h.readInt();
//    int cell_no = script_h.readInt();
//    int alpha = script_h.readInt();
...
//}
//
//int NativeScript::drawfillCommand()
//{
...
//}
//
//int NativeScript::drawclearCommand()
//{
...
//}
//
//int NativeScript::drawbgCommand()
//{
//    SDL_Rect clip = {0, 0, accumulation_surface->w, accumulation_surface->h};
...
//}
//
//int NativeScript::drawbg2Command()
//{
...
//}
//
//int NativeScript::defineresetCommand()
//{
//    saveGlovalData();
//
//    script_h.reset();
...
//}
//
//int NativeScript::cselgotoCommand()
//{
//    int csel_no = script_h.readInt();
//
//    int counter = 0;
...
//}
//
//int NativeScript::cselbtnCommand()
//{
//    int csel_no   = script_h.readInt();
...
//}
//
//int NativeScript::checkpageCommand()
//{
//    script_h.readVariable();
//    script_h.pushVariable();
//
...
//}
//
//int NativeScript::checkkeyCommand()
//{
//    script_h.readVariable();
//    script_h.pushVariable();
...
//}
//
//int NativeScript::captionCommand()
//{
//    const char* buf = script_h.readStr();
...
//}
//
//int NativeScript::btnwaitCommand()
//{
...
//}
//
//int NativeScript::btntimeCommand()
//{
...
//}
//
//int NativeScript::btndownCommand()
//{
...
//}
//
//int NativeScript::btndefCommand()
//{
...
//}
//
//int NativeScript::bgcopyCommand()
//{
//    ofscopyCommand();
//    
...
//}
//
//int NativeScript::barclearCommand()
//{
//    for ( int i=0 ; i<MAX_PARAM_NUM ; i++ ) {
//        if ( bar_info[i] ) {
...
//}
//
//int NativeScript::automode_timeCommand()
//{
...
//}
//
//int NativeScript::autoclickCommand()
//{
...
//}
//
//int NativeScript::allsp2resumeCommand()
//{
...
//}
//
//int NativeScript::allspresumeCommand()
//{
...
//}
//
//int NativeScript::allsp2hideCommand()
//{
...
//}
//
//int NativeScript::allsphideCommand()
//{
